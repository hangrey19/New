...
router.post("/createHomework", auth, homeworkController.createHomework);
router.post("/removeHomework", auth, homeworkController.removeHomework);
router.post(
  "/getAllHomeworkMetadataOfClass",
  auth,
  homeworkController.getAllHomeworkMetadataOfClass
);
router.post("/getHomeworkDetail", auth, homeworkController.getHomeworkDetail);
router.post(
  "/changeHomeworkDeadline",
  auth,
  homeworkController.editHomeworkDeadline
);
...
router.post(
  ...
  auth,
  upload.single("file"),
  homeworkController.changeHomeworkFile
);
