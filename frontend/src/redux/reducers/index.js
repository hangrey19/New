...
import {
  ...
  updatePostReducer,
  deletePostReducer,
} from "../modules/Stream/Post/reducer";
import {
  createCommentReducer,
  updateCommentReducer,
  deleteCommentReducer,
} from "../modules/Stream/Comment/reducer";
import {
  updateHomeworkReducer,
  updateHomeworkFileReducer,
  updateDocumentReducer,
  updateDocumentFileReducer,
} from "../modules/UpdateHomeworkDocument/reducer";
...
import {
  ...
  addScoreReducer,
} from "../modules/HomeworkDetail/reducer";
import {
  fetchAllScoreClassroomReducer,
  fetchAllScoreUserReducer,
} from "../modules/Grade/reducer";
import {
  changeAvatarReducer,
  changeInformationReducer,
} from "../modules/UserAccount/reducer";
