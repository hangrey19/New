...
export const actFetchPeopleList = (classroomId) => {
  ...
  console.log("Fetching people list for classroom:", classroomId);
  ...
  return (dispatch) => {
    ...
    axios({
      ...
      .then((res) => {
        console.log("People list API response:", res.data);
        dispatch(actPeopleSuccess(res.data));
      })
      .catch((err) => {
        console.log(
          "People list API error:",
...
export const actInviteStudent = (classroomId, username) => {
  ...
  console.log("Inviting student:", { classroomId, username });
  ...
  return (dispatch) => {
    ...
    axios({
      ...
      .then((res) => {
        console.log("Invite student API response:", res.data);
        dispatch(actInviteStudentSuccess(res.data));
      })
      .catch((err) => {
        console.log(
          "Invite student API error:",
          err.response?.data || err.message
        );
